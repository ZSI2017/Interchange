...
var Express = new Object({
    init:function(){
        showLoading();
        ant.getSessionData({
                keys: ['filterCompanyId','cityCode','sendAreaCode','recAreaCode','epCompanyId','epCompanyName','oldEpCompanyName']
            }, function (result) {
                ...
                var nextUrl = "information-fill-placeorder.html"
                ...
                console.log("是否从选快递下单页面转来" +result.data.epCompanyId )
                 ...
                 if(result.data.epCompanyId&&result.data.epCompanyId!=""&&window.isServicing!="1"){
                          ...
                          $(".sorrynotic").show();
                          $("#oldExpressName").html(result.data.oldEpCompanyName);
