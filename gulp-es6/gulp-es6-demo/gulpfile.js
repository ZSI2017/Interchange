...
// 压缩HTML 中的js
var inklinesource = require('gulp-inline-source');
...
//  默认的任务，,
gulp.task('default', [ 'packjs','copy-index','json','css','copy-images','copy-libs-config','packlibs'], function() {
